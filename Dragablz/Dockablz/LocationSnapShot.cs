...
namespace Dragablz.Dockablz {
    ...
    internal class LocationSnapShot {
        ...
        public void Apply(FrameworkElement frameworkElement) {
            ...
            frameworkElement.SetCurrentValue(FrameworkElement.WidthProperty, this._width);
            frameworkElement.SetCurrentValue(FrameworkElement.HeightProperty, this._height);
        }
    }
}