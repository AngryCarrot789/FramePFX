...
namespace Dragablz {
    public class Trapezoid : ContentControl {
        ...
        public Brush PenBrush {
            get { return (Brush) this.GetValue(PenBrushProperty); }
            set { this.SetValue(PenBrushProperty, value); }
        }
        ...
        public Brush LongBasePenBrush {
            get { return (Brush) this.GetValue(LongBasePenBrushProperty); }
            set { this.SetValue(LongBasePenBrushProperty, value); }
        }
        ...
        protected override Size MeasureOverride(Size constraint) {
            ...
            this._pathGeometry = CreateGeometry(contentDesiredSize);
            this.Clip = this._pathGeometry;

            return this._pathGeometry.GetRenderBounds(new Pen(this.PenBrush, 1) {
        ...
        private Pen CreatePen() {
            return new Pen(this.PenBrush, this.PenThickness) {
                EndLineCap = PenLineCap.Flat,
                MiterLimit = 1
            };
        }
        ...
        protected override void OnRender(DrawingContext drawingContext) {
            ...
            drawingContext.DrawGeometry(this.Background, this.CreatePen(), this._pathGeometry);

            if (this._pathGeometry == null)
                return;
            drawingContext.DrawGeometry(this.Background, new Pen(this.LongBasePenBrush, this.PenThickness) {
                EndLineCap = PenLineCap.Flat,
                MiterLimit = 1
            }, new LineGeometry(this._pathGeometry.Bounds.BottomLeft + new Vector(3, 0), this._pathGeometry.Bounds.BottomRight + new Vector(-3, 0)));
        }
    }
}