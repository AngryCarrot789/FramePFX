...
public delegate void ConfigurationPanelEditorActiveContextChangedEventHandler(ConfigurationPanelEditor sender, ConfigurationContext? oldActiveContext, ConfigurationContext? newActiveContext);

public partial class ConfigurationPanelEditor : UserControl
{
    public static readonly StyledProperty<ConfigurationManager?> ConfigurationManagerProperty = AvaloniaProperty.Register<ConfigurationPanelEditor, ConfigurationManager?>(nameof(ConfigurationManager));
    ...
    public ConfigurationPanelEditor()
    {
    ...
    static ConfigurationPanelEditor()
    {
        ConfigurationManagerProperty.Changed.AddClassHandler<ConfigurationPanelEditor, ConfigurationManager?>((d, e) => d.OnConfigurationManagerChanged(e.OldValue.GetValueOrDefault(), e.NewValue.GetValueOrDefault()));
    }
    ...
    private class HyperlinkTagInfo
    {
        ...
        public ConfigurationPanelEditor? Editor => (ConfigurationPanelEditor?) this.editor.Target;

        public HyperlinkTagInfo(ConfigurationEntry entry, ConfigurationPanelEditor editor)
        {
    ...
    private static void OnHyperlinkClicked(object? sender, RoutedEventArgs e)
    {
        ...
        {
            if (info.Editor is ConfigurationPanelEditor editor && info.Entry is ConfigurationEntry entry)
            {
