...
public class PropertyEditorGridGroupControl : TemplatedControl {
    ...
    private readonly AutoEventPropertyBinder<BasePropertyEditorGroup> isVisibleBinder = new AutoEventPropertyBinder<BasePropertyEditorGroup>(nameof(BasePropertyEditorGroup.IsCurrentlyApplicableChanged), obj => ((PropertyEditorGridGroupControl) obj.Control).IsVisible = obj.Model.IsRoot || obj.Model.IsVisible);
    private readonly AutoEventPropertyBinder<BasePropertyEditorGroup> isExpandedBinder = new AutoEventPropertyBinder<BasePropertyEditorGroup>(nameof(BasePropertyEditorGroup.IsExpandedChanged), obj => ((PropertyEditorGridGroupControl) obj.Control).IsExpanded = obj.Model.IsExpanded, obj => obj.Model.IsExpanded = ((PropertyEditorGridGroupControl) obj.Control).IsExpanded);
