...
namespace FFmpeg.AutoGen
{
    ...
    public unsafe struct void_ptrArray2
    {
        ...
        {
            get { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (void** p0 = &this._0) { return *(p0 + i); } }
            set { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (void** p0 = &this._0) { *(p0 + i) = value;  } }
        }
        public void*[] ToArray()
        {
            fixed (void** p0 = &this._0) { var a = new void*[Size]; for (uint i = 0; i < Size; i++) a[i] = *(p0 + i); return a; }
        }
        public void UpdateFrom(void*[] array)
        {
            fixed (void** p0 = &this._0) { uint i = 0; foreach(var value in array) { *(p0 + i++) = value; if (i >= Size) return; } }
        }
    ...
    public unsafe struct byte_ptrArray3
    {
        ...
        {
            get { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (byte** p0 = &this._0) { return *(p0 + i); } }
            set { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (byte** p0 = &this._0) { *(p0 + i) = value;  } }
        }
        public byte*[] ToArray()
        {
            fixed (byte** p0 = &this._0) { var a = new byte*[Size]; for (uint i = 0; i < Size; i++) a[i] = *(p0 + i); return a; }
        }
        public void UpdateFrom(byte*[] array)
        {
            fixed (byte** p0 = &this._0) { uint i = 0; foreach(var value in array) { *(p0 + i++) = value; if (i >= Size) return; } }
        }
    ...
    public unsafe struct AVComponentDescriptor_array4
    {
        ...
        {
            get { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (AVComponentDescriptor* p0 = &this._0) { return *(p0 + i); } }
            set { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (AVComponentDescriptor* p0 = &this._0) { *(p0 + i) = value;  } }
        }
        public AVComponentDescriptor[] ToArray()
        {
            fixed (AVComponentDescriptor* p0 = &this._0) { var a = new AVComponentDescriptor[Size]; for (uint i = 0; i < Size; i++) a[i] = *(p0 + i); return a; }
        }
        public void UpdateFrom(AVComponentDescriptor[] array)
        {
            fixed (AVComponentDescriptor* p0 = &this._0) { uint i = 0; foreach(var value in array) { *(p0 + i++) = value; if (i >= Size) return; } }
        }
    ...
    public unsafe struct short_arrayOfArray6
    {
        ...
        {
            get { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (short_array2* p0 = &this._0) { return *(p0 + i); } }
            set { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (short_array2* p0 = &this._0) { *(p0 + i) = value;  } }
        }
        public short_array2[] ToArray()
        {
            fixed (short_array2* p0 = &this._0) { var a = new short_array2[Size]; for (uint i = 0; i < Size; i++) a[i] = *(p0 + i); return a; }
        }
        public void UpdateFrom(short_array2[] array)
        {
            fixed (short_array2* p0 = &this._0) { uint i = 0; foreach(var value in array) { *(p0 + i++) = value; if (i >= Size) return; } }
        }
    ...
    public unsafe struct AVBufferRef_ptrArray8
    {
        ...
        {
            get { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (AVBufferRef** p0 = &this._0) { return *(p0 + i); } }
            set { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (AVBufferRef** p0 = &this._0) { *(p0 + i) = value;  } }
        }
        public AVBufferRef*[] ToArray()
        {
            fixed (AVBufferRef** p0 = &this._0) { var a = new AVBufferRef*[Size]; for (uint i = 0; i < Size; i++) a[i] = *(p0 + i); return a; }
        }
        public void UpdateFrom(AVBufferRef*[] array)
        {
            fixed (AVBufferRef** p0 = &this._0) { uint i = 0; foreach(var value in array) { *(p0 + i++) = value; if (i >= Size) return; } }
        }
    ...
    public unsafe struct double_arrayOfArray798
    {
        ...
        {
            get { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (double_array399* p0 = &this._0) { return *(p0 + i); } }
            set { if (i >= Size) throw new ArgumentOutOfRangeException(); fixed (double_array399* p0 = &this._0) { *(p0 + i) = value;  } }
        }
        public double_array399[] ToArray()
        {
            fixed (double_array399* p0 = &this._0) { var a = new double_array399[Size]; for (uint i = 0; i < Size; i++) a[i] = *(p0 + i); return a; }
        }
        public void UpdateFrom(double_array399[] array)
        {
            fixed (double_array399* p0 = &this._0) { uint i = 0; foreach(var value in array) { *(p0 + i++) = value; if (i >= Size) return; } }
        }
