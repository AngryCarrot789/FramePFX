...
namespace FramePFX.Editor.Timeline.ViewModels.Clips {
    ...
    public abstract class PFXVideoClip : PFXBaseClip, IContextProvider, IVideoClip {
        ...
        public long FrameBegin {
            get => this.frameBegin;
            set => this.RaisePropertyChanged(ref this.frameBegin, value, this.InvalidateRenderForPropertyChanged);
        }
        ...
        public long FrameDuration {
            ...
            set => this.RaisePropertyChanged(ref this.frameDuration, value, this.InvalidateRenderForPropertyChanged);
        }
