...
namespace FramePFX.Editor.ViewModels.Timelines.Clips {
    ...
    public abstract class VideoClipViewModel : ClipViewModel {
        ...
        public MotionEffectViewModel Motion => (MotionEffectViewModel) this.Effects[0];
        ...
        private void UpdateCommands() {
            this.Motion.InsertMediaPositionKeyFrameCommand.RaiseCanExecuteChanged();
            this.Motion.InsertMediaScaleKeyFrameCommand.RaiseCanExecuteChanged();
            this.Motion.InsertMediaScaleOriginKeyFrameCommand.RaiseCanExecuteChanged();
