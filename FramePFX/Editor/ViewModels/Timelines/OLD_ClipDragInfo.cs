...
namespace FramePFX.Editor.ViewModels.Timelines {
    public class OLD_ClipDragInfo {
        ...
        private OLD_ClipDragInfo(TimelineViewModel timeline, ClipViewModel source, IEnumerable<ClipViewModel> selectionWithoutSource) {
        ...
        public static OLD_ClipDragInfo FromClip(ClipViewModel source) {
            ...
            return new OLD_ClipDragInfo(timeline, source, clips);
        }
    }

    public class ClipDragInfoData {
        public readonly OLD_ClipDragInfo drag;
        public readonly ClipViewModel clip;
        public FrameSpan OriginalSpan;
        public FrameSpan DragBody, DragLeft, DragRight;
        public long excess;

        public ClipDragInfoData(OLD_ClipDragInfo drag, ClipViewModel clip) {
            this.drag = drag;
            this.clip = clip;
