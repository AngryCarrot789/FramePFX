...
namespace FramePFX.Editors.DataTransfer {
    public sealed class DataParameterLong : DataParameterGeneric<long> {
        ...
        public DataParameterLong(Type ownerType, string key, ValueAccessor<long> accessor, DataParameterFlags flags) : this(ownerType, key, 0L, accessor, flags) {

        }

        public DataParameterLong(Type ownerType, string key, long defValue, ValueAccessor<long> accessor, DataParameterFlags flags) : this(ownerType, key, defValue, long.MinValue, long.MaxValue, accessor, flags) {

        }

        public DataParameterLong(Type ownerType, string key, long defValue, long minValue, long maxValue, ValueAccessor<long> accessor, DataParameterFlags flags) : base(ownerType, key, defValue, accessor, flags) {
