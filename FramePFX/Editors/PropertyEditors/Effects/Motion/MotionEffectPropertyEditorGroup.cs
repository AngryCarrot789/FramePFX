...
namespace FramePFX.Editors.PropertyEditors.Effects.Motion {
    public class MotionEffectPropertyEditorGroup : EffectPropertyEditorGroup {
        ...
        public MotionEffectPropertyEditorGroup() : base(typeof(MotionEffect)) {
            ...
            this.AddItem(new ParameterVector2PropertyEditorSlot(MotionEffect.MediaPositionParameter, typeof(MotionEffect), "Pos", DragStepProfile.HugeRange));
            ...
            this.AddItem(new ParameterVector2PropertyEditorSlot(MotionEffect.MediaScaleOriginParameter, typeof(MotionEffect), "Scale Origin", DragStepProfile.HugeRange));
            ...
            this.AddItem(new ParameterVector2PropertyEditorSlot(MotionEffect.MediaRotationOriginParameter, typeof(MotionEffect), "Rotation Origin", DragStepProfile.HugeRange));
        }
    }
}