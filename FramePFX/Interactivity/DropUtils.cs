namespace FramePFX.Interactivity {
    public static class DropUtils {
        public static EnumDropType GetDropAction(int keyStates, EnumDropType effects, EnumDropType defaultDropType = EnumDropType.Copy) {
            ...
            else if ((effects & defaultDropType) == defaultDropType) {
                return defaultDropType;
            }
