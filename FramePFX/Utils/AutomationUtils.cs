        ...
        public static void SetValue(KeyFrame keyFrame, object value) {
            switch (keyFrame.DataType) {
                case AutomationDataType.Float:
                    keyFrame.SetFloatValue((float) value);
                    break;
                case AutomationDataType.Double:
                    keyFrame.SetDoubleValue((double) value);
                    break;
                case AutomationDataType.Long:
                    keyFrame.SetLongValue((long) value);
                    break;
                case AutomationDataType.Boolean:
                    keyFrame.SetBooleanValue((bool) value);
                    break;
                case AutomationDataType.Vector2:
                    keyFrame.SetVector2Value((Vector2) value);
                    break;
