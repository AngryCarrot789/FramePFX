...
namespace PFXToolKitUI.Avalonia.Windows;
...
public abstract class NewWindowManager {
    ...
    private readonly global::Avalonia.Application app;

    public NewWindowManager() {
        this.app = global::Avalonia.Application.Current ?? throw new InvalidOperationException("No application initialised");
